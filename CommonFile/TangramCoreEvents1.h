...
{
public:
	virtual void __stdcall OnOpenComplete(long hWnd, BSTR bstrUrl, IStar* pRootGrid){}
...
class CGridEvents : public IDispEventSimpleImpl</*nID =*/ 1, CGridEvents, &__uuidof(_IStarEvents)>
{
public:
