...
class ATL_NO_VTABLE CEclipseExtender :
	...
	public IDispatchImpl<IEclipseExtender, &IID_IEclipseExtender, &LIBID_World, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
...
class ATL_NO_VTABLE CEclipseWnd :
	...
	public CComObjectRootEx<CComSingleThreadModel>,
	public IDispatchImpl<IWorkBenchWindow, &IID_IWorkBenchWindow, &LIBID_World, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
	CEclipseWnd(void);
...
class ATL_NO_VTABLE CEclipseCtrl :
	...
	public IDispatchImpl<IEclipseCtrl, &IID_IEclipseCtrl, &LIBID_World, 1, 0>
{
public:
