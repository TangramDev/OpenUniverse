...
void registerNatives(JNIEnv *env) {
	...
	if (bridge != NULL) {
		...
		natives[0] = { "_update_splash", "()V", (void *)&update_splash };
		natives[1] = { "_get_splash_handle", "()J", (void *)&get_splash_handle };
		natives[2] = { "_set_exit_data", "(Ljava/lang/String;Ljava/lang/String;)V", (void *)&set_exit_data };
		natives[3] = { "_set_launcher_info", "(Ljava/lang/String;Ljava/lang/String;)V", (void *)&set_launcher_info };
		natives[4] = { "_show_splash", "(Ljava/lang/String;)V", (void *)&show_splash };
		natives[5] = { "_takedown_splash", "()V", (void *)&takedown_splash };
		natives[6] = { "_get_os_recommended_folder", "()Ljava/lang/String;", (void *)&get_os_recommended_folder };
	...
	if (tangramClass != NULL) {
		...
		{
			{ "_extend", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", (void *)&tangram_extend }
		};
