...
void CGridWnd::StopTracking(BOOL bAccept)
{
	...
	if (bAccept)
	{
		...
		if (g_pCosmos->m_pMDIMainWnd && g_pCosmos->m_pMDIMainWnd->m_pClientXobj &&
			g_pCosmos->m_pMDIMainWnd->m_pClientXobj->m_pRootObj == m_pXobj->m_pRootObj)
