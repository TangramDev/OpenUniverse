...
class CONTENT_EXPORT RenderFrameHostImpl :
 ...
 private:
  ...
  void Insertint64(CommonUniverse::IPCSession*, CString key, __int64 value) override;
  void InsertFloat(CommonUniverse::IPCSession*, CString key, float value) override;
  ...
  void OnHubbleMessage(std::wstring id,
      std::wstring param1,
      std::wstring param2,
      std::wstring param3,
      std::wstring param4,
  ...
  void OnHubbleMessage2(std::wstring id,
      std::wstring param1,
      long handle,
      long nID,
      std::wstring param4,
  ...
  //void OnHubbleMessage3(std::wstring id,
  //    std::wstring param1,
  //    long fromhandle,
  //    std::wstring param3,
  //    long tohandle,
  ...
  void SendHubbleMessage(CommonUniverse::IPCSession* var) override;
  void SendHubbleMessage(CommonUniverse::IPCMsg*) override;
  // end Add by TangramTeam
