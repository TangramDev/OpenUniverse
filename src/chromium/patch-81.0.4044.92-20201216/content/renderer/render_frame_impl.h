...
class CONTENT_EXPORT RenderFrameImpl
 ...
 public:
  ...
  // begin Add by TangramTeam
  void SendHubbleMessageEx(blink::CommonUniverse::IPCSession& var) override;
  void SendHubbleMessage(std::wstring id,
                          std::wstring param1,
                          std::wstring param2,
                          std::wstring param3,
                          std::wstring param4,
  ...
  void SetDocumentInterfaceBrokerForTesting(
      mojo::PendingRemote<blink::mojom::BrowserInterfaceBroker> test_broker);
