...
BEGIN_MESSAGE_MAP(CMFCApplication3App, CWinAppEx)
	...
	ON_COMMAND(ID_FILE_NEW_FRAME, &CMFCApplication3App::OnFileNewFrame)
...
{
	theDelegate.m_mapDOMObjInfo[_T("main_panel")] = RUNTIME_CLASS(CMFCApplication3View);
...
// CMFCApplication3App customization load/save methods
...
void CMFCApplication3App::OnFileNewFrame()
{
