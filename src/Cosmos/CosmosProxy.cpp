...
void CCosmosProxy::CosmosAction(BSTR bstrXml, void* pvoid)
{
	...
	if (strXml != _T(""))
	{
		...
		{
			if (DOMPlus::Cosmos::MainForm != nullptr)
			{
				theApp.m_pCosmosImpl->m_hMainWnd = (HWND)DOMPlus::Cosmos::MainForm->Handle.ToPointer();
			}
			return;
		}
		...
		//		if (nPos != -1)
		//		{
		//			UniverseCLRCosmos::Cosmos::Fire_OnCosmosIPCMessage(pWndGrid, BSTR2STRING(strXml));
		//		}
		//		else
		//			UniverseCLRCosmos::Cosmos::Fire_OnCosmosLoadDocument2Viewport(pWndGrid, BSTR2STRING(strXml));
		//	}
		//}
	}
}
