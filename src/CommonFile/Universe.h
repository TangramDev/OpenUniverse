...
#ifndef __DOMPlus_FWD_DEFINED__
#define __DOMPlus_FWD_DEFINED__

#ifdef __cplusplus
typedef class DOMPlus DOMPlus;
#else
typedef struct DOMPlus DOMPlus;
#endif /* __cplusplus */

#endif 	/* __DOMPlus_FWD_DEFINED__ */
...
EXTERN_C const CLSID CLSID_DOMPlus;
