...
int MainDllLoader::Launch(HINSTANCE instance,
  ...
  {
	  delete g_pHubbleImpl->m_pBrowserFactory;
	  g_pHubbleImpl->m_pBrowserFactory = nullptr;
  }
  // end Add by TangramTeam
  OnBeforeExit(file);
  return rc;
...
class ChromiumDllLoader : public MainDllLoader {
 protected:
	 ...
	 void LaunchEx(CommonUniverse::CHubbleImpl* pTangramImpl) override
	 {
		 g_pHubbleImpl = pTangramImpl;
